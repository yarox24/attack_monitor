...
class feeder_evtx_powershell_operational(Feeder):

    def getName(self):
        return 'evtx_powershell_operational'

    def run(self):
        for er in evtx_subscriber.subscribe_and_yield_events('Microsoft-Windows-PowerShell/Operational'):
